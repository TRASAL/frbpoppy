...
# -*- coding: utf-8 -*-
#
# frbpoppy documentation build configuration file, created by
...
project = 'frbpoppy'
copyright = '2020, David Gardenier'
...
latex_documents = [
    (master_doc, 'frbpoppy.tex', 'frbpoppy Documentation',
     'David Gardenier', 'manual'),
]
